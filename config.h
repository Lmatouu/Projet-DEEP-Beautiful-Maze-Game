...
#define USE_ADC					0
	...
	#define USE_AN13		1	//Broche correspondante : PC3	//Sur la Bluepill, cette broche n'est pas câblée !
	#define USE_AN14		1	//Broche correspondante : PC4	//Sur la Bluepill, cette broche n'est pas câblée !
